...
export default function AttendanceRegisterDetails() {
  ...
  return (
    <div className="min-h-screen bg-[#f8faf5] px-4 sm:px-6 py-8">
      <div
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div
                className="border rounded-2xl p-3 bg-white max-h-[420px] overflow-y-auto"
                style={{ borderColor: BRAND.border }}
              >
                  ...
                  {SUBJECTS.map((subject) => {
                    ...
                    return (
                      <button
                        ...
                        className={
                          active
                            ? 'w-full text-left rounded-xl px-4 py-3 border transition-transform duration-150 shadow-sm'
                            : 'w-full text-left rounded-xl px-4 py-3 border transition-transform duration-150 hover:scale-[1.02] shadow-sm'
                        }
                        style={{
                          borderColor: active ? BRAND.green : BRAND.border,
                          backgroundColor: active ? 'rgba(15,157,120,0.08)' : 'white'
                        }}
