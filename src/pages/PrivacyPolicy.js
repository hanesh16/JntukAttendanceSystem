    ...
    <div className="min-h-screen bg-[#f8faf5] px-4 sm:px-6 py-10">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl sm:text-3xl font-extrabold" style={{ color: BRAND.heading }}>
            Privacy <span style={{ color: BRAND.primary }}>Policy</span>
          </h1>
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="px-2 py-1 rounded-xl border font-semibold transition-colors flex items-center gap-1 text-sm"
            style={{
          ...
          >
            <span style={{ display: 'inline-block', fontSize: '1em', lineHeight: 1 }} aria-hidden="true">&#8592;</span>
            Back
          </button>
        </div>
        <div className="text-base space-y-6" style={{ color: BRAND.body }}>
          <p>
            The Students Portal is an online platform provided by Jawaharlal Nehru Technological University Kakinada (JNTUK) for the exclusive use of its students and faculty. This portal serves as a photo-based attendance system and a learning management system, supporting academic activities and institutional requirements. We are committed to protecting the privacy and security of all users and their data.
          </p>
          <p>
